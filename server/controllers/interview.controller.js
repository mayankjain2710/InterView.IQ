...
`,
    ...
    if (questionsArray.length === 0) {
      return res
        .status(500)
        .json({ message: "AI Failed to generate interview questions." });
    }
    ...
    const interview = await Interview.create({
      ...
      questions: questionsArray.map((q, index) => ({
        question: q,
        difficulty: ["easy", "easy", "medium", "medium", "hard"][index], // You can set the difficulty based on your logic
        timeLimit: [60, 60, 90, 90, 120][index], // You can set a default time limit or based on your logic
      })),
    });
